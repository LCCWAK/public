const WeatherApp = class {
    ...
    drawWeather() {
		...
		// show content holder
		document.getElementById("weatherHolder").style.display = "block";
		
        // add current weather block
        if (this.currentWeather) {
			//create nice css
			var h2 = document.createElement("h2");
			h2.setAttribute("id", "part1Name");
			document.getElementById("weather-results-container").appendChild(h2);
			document.getElementById("part1Name").innerHTML = "Weather Right Now";
			
			var hr = document.createElement("hr");
			document.getElementById("weather-results-container").appendChild(hr);
        ...
        if (this.forecast && this.forecast.length > 0) {
			//create nice css
			var h2 = document.createElement("h2");
			h2.setAttribute("id", "part2Name");
			document.getElementById("weather-results-container").appendChild(h2);
			document.getElementById("part2Name").innerHTML = "Weather in 5 Days";
